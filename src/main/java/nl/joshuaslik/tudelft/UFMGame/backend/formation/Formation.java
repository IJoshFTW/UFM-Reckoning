...
public abstract class Formation {
	 ...
	 * @param fieldplayer new central back player
	 ...
	 * @param fieldplayer new right back player
	 ...
	 * @param fieldplayer new left back player
	 ...
	 * @param fieldplayer new central back player 1
	 ...
	 * @param fieldplayer new central back player 2
	 ...
	 * @param fieldplayer new central midfield player
	 ...
	 * @param fieldplayer new central midfield player 1
	 ...
	 * @param fieldplayer new central midfield player 2
	 ...
	 * @param fieldplayer new right midfield player
	 ...
	 * @param fieldplayer new left midfield player
	 ...
	 * @param fieldplayer new right wing player
	 ...
	 * @param fieldplayer new left wing player
	 ...
	 * @param fieldplayer new offensive left midfield player
	 ...
	 * @param fieldplayer new offensive right midfield player
	 ...
	 * @param fieldplayer new central back 3
