...
public class NewGameController {
	...
	@FXML
	private TableColumn<Team, String> teamColumn, coachColumn, averagedefence,
			averagestamina, averageattack, totalplayers, teamvalue;
	 ...
	 * 
	 * @param user
	 *            The username that is chosen in the previous dialog
	 * @throws IOException
	...
	public static void start(String user) throws IOException {
		...
		AnchorPane scene = FXMLLoader.load(Class.class
